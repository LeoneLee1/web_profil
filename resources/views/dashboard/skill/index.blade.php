...
@section('konten')
    <form action="{{ route('skill.update') }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text"
            class="form-control form control-sm skill" name="_language" id="judul" aria-describedby="helpId" placeholder="PROGRAMMING LANGUAGES & TOOLS" value="{{ get_meta_value('_language') }}">
